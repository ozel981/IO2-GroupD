...
import { getCategoriesFetch, postCommentFetch, deletePostFetch, putPostFetch, putLikeStatusPostFetch, getPostCommentsFetch } from '../../apiMethods'
...
const Post = (props) => {
  ...
  return (
    <div id="post-div">
      <div id={'post-' + props.post.id + '-div'} className="container border border-light rounded-lg" style={{ backgroundColor: props.post.isPromoted ? '#d9d9d9' : '#f2f5f7', padding: '10px' }}>
        <div className="row no-gutters">
          ...
          {props.user.isActive &&
          <div className="col-1">
            {(props.post.authorID.toString() === props.authId.toString() || props.user.isAdmin)
