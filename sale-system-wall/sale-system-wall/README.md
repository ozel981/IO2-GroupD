...
## Docker
- budowanie obrazu: `docker build -t wall .`
- uruchomienie obrazu na Windowsie: `docker run -it --rm -v %cd%:/app -v /app/node_modules -p 3001:3000 -e CHOKIDAR_USEPOLLING=true -e REACT_APP_API_SERVER=<adres api serwera> wall`
- obecne ustawienia pozwalają na dynamiczną edycję kodu
